    ...
    <section class="hero-details">
      <v-card class="details-card mx-auto">
        ...
        <p class="card-subtitle mb-6">
          View your MRI scan and the AI-generated heatmap. 
          The heatmap highlights the regions of the brain the AI focused on to make its prediction. 
          Brighter areas show where the model detected patterns relevant to its analysis.
        </p>
        ...
        <v-row>
          <v-col cols="12" md="6">
            ...
            <v-img
              :src="'http://localhost:5001/' + prediction.original_image_path"
          ...
          <v-col cols="12" md="6">
            ...
            <v-img
              :src="'http://localhost:5001/' + prediction.heatmap_image_path"
              class="rounded-xl image-box"
              height="280"
              contain
            />
        ...
        <v-row>
        <v-col cols="12" md="6" class="col-right-margin">
...
.details-card {
  ...
  max-width: 1200px;
  border-radius: 2rem;
  background: linear-gradient(145deg, #f2f2f2, #ebdef5);
